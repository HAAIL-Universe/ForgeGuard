...
_ROLE_SYSTEM_PROMPTS: dict[SubAgentRole, str] = {
    ...
    SubAgentRole.CODER: (
        ...
        "5. dependency_contracts.md — EXACT signatures of classes/functions your\n"
        "   dependencies export. Use THESE names and signatures when importing.\n"
        "   Do NOT rename, redefine, or create your own versions of types that\n"
        "   already exist in your dependency chain.\n"
        "6. implementation_contract.md — the public API this file MUST export.\n"
        "   Implement every item listed. Match names, params, and return types.\n\n"
        "# PROCESS\n"
        ...
        "# DEPENDENCY CONTRACT RULES — VIOLATION IS A BUILD FAILURE\n"
        "- If dependency_contracts.md is in your context, EVERY import from a\n"
        "  dependency MUST match the class/function names listed there EXACTLY.\n"
        "  Do NOT redefine enums, models, or types that a dependency already exports.\n"
        "- If implementation_contract.md is in your context, implement EXACTLY\n"
        "  the interfaces listed. Match names, parameter types, and return types.\n"
        "- For __init__.py files: output ONLY an empty file or minimal re-exports.\n"
        "  Never output prose, commentary, or explanatory text.\n"
        "- When mounting routers: check if the router already defines a prefix.\n"
        "  Do NOT double-up prefixes (e.g., router has /timers, main adds /timers).\n\n"
    ...
    SubAgentRole.AUDITOR: (
        ...
        "- File redefines a type/enum/class that dependency_contracts.md shows\n"
        "  is already exported by a dependency (must import, not redefine)\n"
        "- Import uses wrong class/function name vs dependency_contracts.md\n"
        "- __init__.py contains non-code content (prose, commentary, tutorials)\n"
        "- Router prefix chain creates double-prefix when mounted in main.py\n\n"
