    ...
    *,
    ...
    for phase in phases:
        ...
        if audit_verdict == "PASS" and verification_clean and governance_clean:
            ...
            # Auto-continue on partial verdicts — phase review gate will be
            # wired to the UI Pause button in a future iteration.
            logger.info(
                "Phase %s partial — auto-continuing (issues logged above)",
                phase_name,
            )
