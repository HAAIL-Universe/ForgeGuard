...
## Minimal Diff Hunks
    ...
    -    +1. product_intent ├ö├ç├Â What the product does, who it's for, key features
    -    +2. tech_stack ├ö├ç├Â Backend/frontend languages, frameworks, database, deployment
    -    +3. database_schema ├ö├ç├Â Tables, columns, relationships, constraints
    -    +4. api_endpoints ├ö├ç├Â REST/GraphQL endpoints, auth, request/response shapes
    ...
    -    @@ -0,0 +1,33 @@
    -    +# Builder Contract ├ö├ç├Â {project_name}
    +    +# ---------------------------------------------------------------------------
    ...
    -    +1. **Static** ├ö├ç├Â Syntax checks, linting
    -    +2. **Runtime** ├ö├ç├Â Application boots successfully
    -    +3. **Behavior** ├ö├ç├Â All tests pass
    -    +4. **Contract** ├ö├ç├Â Boundary compliance, schema conformance
    ...
    -    @@ -0,0 +1,13 @@
    -    +# Builder Directive ├ö├ç├Â {project_name}
         +
    -    +AEM: enabled
    ...
    +    +    }
         +
    -    +1. **Quality over speed** ├ö├ç├Â Every commit must pass automated governance checks.
    -    +2. **Evidence-based progress** ├ö├ç├Â All changes are audited.
    -    +3. **Deterministic builds** ├ö├ç├Â Same inputs always produce same outputs.
    +    +    client_instance = AsyncMock()
    +    +    client_instance.post.return_value = response
    +    +    client_instance.__aenter__ = AsyncMock(return_value=client_instance)
    +    +    client_instance.__aexit__ = AsyncMock(return_value=False)
    ...
    -    @@ -0,0 +1,30 @@
    -    +# {project_name} ├ö├ç├Â Database Schema
    ...
    -    @@ -0,0 +1,13 @@
    -    +# {project_name} ├ö├ç├Â UI Specification
    ...
    +
    +
    +# ÔöÇÔöÇ POST /projects/{project_id}/build/cancel ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    +
    +
    +@router.post("/{project_id}/build/cancel")
    +async def cancel_build(
    ...
    +
    +
    +# ÔöÇÔöÇ GET /projects/{project_id}/build/logs ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    +
    +
    +@router.get("/{project_id}/build/logs")
    +async def get_build_logs(
