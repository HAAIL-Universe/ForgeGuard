...
async def test_create_new_project(mock_create):
    ...
    mock_create.assert_called_once_with(USER_ID, "My Project", None, repo_id=None, local_path=None, build_mode="full")
...
async def test_generate_contracts_success(mock_project, mock_existing, mock_upsert, mock_status, mock_ws, mock_gen):
    mock_project.return_value = {
        "id": PROJECT_ID,
        "user_id": USER_ID,
        "name": "My Project",
